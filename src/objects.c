...
//
void
OBJCreate(OBJECT* ob, LEVELDESC* Lvl)
{
  int i;
...
//
void
OBJMoveEnemy(OBJECT* ob, Uint32 Time, int xPMove, int yPMove, int TMove)
{
  int n;
...
//
int
OBJCheckHitEnemy(OBJECT* ob, int x, int y)
{
  int i, n;
